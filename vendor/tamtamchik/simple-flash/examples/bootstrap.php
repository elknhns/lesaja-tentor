...
flash()->setTemplate(TemplateFactory::create(Templates::BOOTSTRAP));
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/css/bootstrap.min.js"></script>
